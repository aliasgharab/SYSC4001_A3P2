...
```
Example: Run with 2 TA's
./parta 2
./partb 2

Example: Run with 3 TA's
./parta 3
./partb 3
```
...
The implementation in both `parta.c` and `partb.c` demonstrates these principles, providing a robust solution to the critical section problem as required by the assignment.
